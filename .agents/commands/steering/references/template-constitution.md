...
- Performance acceptable (see design.md for targets)
...
- Update the corresponding plan file in .plans/ daily during active development
...
- Update the spec or the corresponding plan file in .plans/ with blocker status
